# [Stanford Starter](https://github.com/SU-SWS/khs_subtheme)
##### Version: 8.x-1.0-dev
...
3. Change all theme file names from including "khs_subtheme" to including the machine name of your theme.
4. Run a search and replace throughout the theme files to replace "khs_subtheme" with the machine name of your theme.
